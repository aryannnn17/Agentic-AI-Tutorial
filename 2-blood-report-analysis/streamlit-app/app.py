...
"""
            ...
            diet_prompt = f"""
You are a clinical nutritionist specializing in Gujarati Indian dietary habits.
...
SECTION 2 - GUJARATI INDIAN DIET PLAN:
List foods to eat more of and foods to avoid, using commonly available Gujarati Indian foods
...
"""
        ...
        if "SECTION 2" in full_response:
            ...
            diet_plan = ("SECTION 2" + parts[1]).replace("SECTION 2 - GUJARATI INDIAN DIET PLAN:", "").replace("SECTION 2", "").strip()
        else:
